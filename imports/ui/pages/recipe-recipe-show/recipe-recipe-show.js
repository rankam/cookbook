import './recipe-recipe-show.html';
...
import '../../components/recipe_list/recipe_show.html';
...
Template.App_recipe_recipe_show.onCreated(function () {
...
Template.App_recipe_recipe_show.helpers({
  selected() {
    return Template.instance().state.get('selected');
  }
});

Template.App_recipe_recipe_show.events({
